...
function requestMethodFactory(methods: HTTPMethods | HTTPMethods[], url: string, options?: RouteShorthandOptions) {
...
export function GET(route: string, options?: RouteShorthandOptions) {
  return requestMethodFactory('GET', route, options);
}

export function HEAD(route: string, options?: RouteShorthandOptions) {
  return requestMethodFactory('HEAD', route, options);
}

export function PATCH(route: string, options?: RouteShorthandOptions) {
  return requestMethodFactory('PATCH', route, options);
}

export function POST(route: string, options?: RouteShorthandOptions) {
  return requestMethodFactory('POST', route, options);
}

export function PUT(route: string, options?: RouteShorthandOptions) {
  return requestMethodFactory('PUT', route, options);
}

export function OPTIONS(route: string, options?: RouteShorthandOptions) {
  return requestMethodFactory('OPTIONS', route, options);
}

export function DELETE(route: string, options?: RouteShorthandOptions) {
  return requestMethodFactory('DELETE', route, options);
}

export function ALL(route: string, methods?: HTTPMethods[] | null, options?: RouteShorthandOptions) {
